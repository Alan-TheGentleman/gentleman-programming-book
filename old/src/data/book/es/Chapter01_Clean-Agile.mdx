  ...
  [
    {
      ...
      id: 'problemas-del-enfoque-en-cascada',
    },
    { name: '¿Por qué ser ágil?', id: 'por-qué-agile' },
    {
      name: 'Por qué crees que estás haciendo agile pero en realidad... no lo estás haciendo',
      id: 'por-qué-piensas-que-estás-haciendo-agile-pero-en-realidad--no-lo-estás-haciendo',
    },
    { name: 'Programación extrema', id: 'programación-extrema' },
    { name: 'Desarrollo guiado por pruebas (TDD)', id: 'tdd' },
    {
      name: 'Diseño atómico, desde la perspectiva del Front End',
      id: 'diseño-atómico-punto-de-vista-de-front-end',
    },
    { name: 'Programación funcional', id: 'programación-funcional' },
    { name: 'Historias de usuario y TDD', id: 'historia-de-usuario-y-tdd' },
  ]
---
