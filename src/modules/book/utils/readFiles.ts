...
export async function readChapter(chapterId?: string, locale = 'en') {
...
export async function getPagination(chapterId?: string, locale = 'en') {
...
export async function generateBookContent(locale = 'en', chapterId?: string) {
	const _postsDirectory = postsDirectory + `/${locale}`;
