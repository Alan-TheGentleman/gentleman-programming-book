...
ina que estás tratando de meter el número 4000. En binario, eso es `111110100000`. Pero aquí está la cosa: nuestro autobús solo llega hasta 127. Entonces, cuando intentas meter 4000 allí, es como intentar meter a un equipo de fútbol en un auto pequeño, simplemente no va a suceder.
...
Y con este ejemplo verás, claro como el agua en las noches más oscuras, que no estoy mintiendo:
