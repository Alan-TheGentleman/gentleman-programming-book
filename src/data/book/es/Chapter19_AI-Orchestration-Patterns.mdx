...
titleList:
  [
    ...
    {
      name: 'El Problema N×M: Por Que Necesitamos Orquestacion',
...
└─────────────────┘
         ...
         ▼  HANDOFF
┌─────────────────┐
│ Billing Agent   │ ◄── PERSISTENTE hasta cambio de tema
│ (MCP: billing-  │
│  server tools)  │
└─────────────────┘
```
...
> _Pensalo asi: MCP es para las conexiones electricas estandar de tu edificio (tomas, luces, aire acondicionado). La integracion directa es para el sistema automatizado custom que diseñaste especificamente para tu edificio inteligente._
