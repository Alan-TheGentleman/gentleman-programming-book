  ...
  [
    {
      ...
      tagId: 'las-empresas-no-están-limitadas-a-una-ubicación-determinada',
    },
    {
      name: 'Coordinación a través de diferentes zonas horarias',
      tagId: 'coordinación-entre-zonas-horarias',
    },
    {
      name: 'Existen otras formas sencillas de mejorar esta mentalidad',
      tagId: 'hay-algunas-otras-formas-sencillas-en-las-que-podemos-mejorar-esta-mentalidad',
    },
    { name: 'Creando conexión', tagId: 'creando-conexión' },
  ]
---
