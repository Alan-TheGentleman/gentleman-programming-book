  ...
  [
    {
      ...
      id: 'companies-are-not-grounded-to-a-certain-location',
    },
    {
      name: 'Coordinación a través de diferentes zonas horarias',
      id: 'coordinating-across-time-zones',
    },
    {
      name: 'Existen otras formas sencillas de mejorar esta mentalidad',
      id: 'there-are-some-other-easy-ways-we-improve-this-mindset',
    },
    { name: 'Creando conexión', id: 'creating-rapport' },
  ]
---
...
- Crea canales para que individuos y equipos se comuniquen y vean actualizaciones, otra gran idea sería crear canales para un futuro determinado y las personas involucradas.
- Dedica tiempo a crear una guía simple pero efectiva de "Cómo empezar".
