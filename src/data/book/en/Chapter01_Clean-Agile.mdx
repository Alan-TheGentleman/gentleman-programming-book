...
titleList:
  [
    { name: 'Problems of waterfall', tagId: 'problems-of-waterfall' },
    { name: 'Why agile?', tagId: 'why-agile' },
    {
      name: "Why you think you are doing agile but in reality…you don't",
      tagId: 'why-you-think-you-are-doing-agile-but-in-realityyou-dont',
    },
    { name: 'Extreme Programming', tagId: 'extreme-programming' },
    { name: 'TDD', tagId: 'tdd' },
    {
      name: 'Atomic design, Front End point of view',
      tagId: 'atomic-design-front-end-point-of-view',
    },
    { name: 'Functional Programming', tagId: 'functional-programming' },
    { name: 'User Story and TDD', tagId: 'user-story-and-tdd' },
  ]
---
