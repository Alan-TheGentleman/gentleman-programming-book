...
titleList:
  ...
  - name: 'Practical Example in TypeScript: The Use of `any` and the Importance of Typing'
    tagId: 'practical-example-in-typescript-the-use-of-any-and-the-importance-of-typing'
  ...
  - name: 'Classes, Interfaces, Enums, and Const: How to Use Them for Typing in TypeScript'
    tagId: 'classes-interfaces-enums-and-const-how-to-use-them-for-typing-in-typescript'
...
function greet<T extends WithName
