...
titleList:
  [
    {
      name: 'Issues with Waterfall Approach',
      tagId: 'issues-with-waterfall-approach',
    },
    { name: 'Why Be Agile?', tagId: 'why-be-agile' },
    {
      name: "Why You Think You're Doing Agile But You're Actually Not",
      tagId: 'why-you-think-youre-doing-agile-but-youre-actually-not',
    },
    { name: 'Extreme Programming', tagId: 'extreme-programming' },
    { name: 'Test-Driven Development (TDD)', tagId: 'tdd' },
    {
      name: 'Atomic Design from a Front-End Perspective',
      tagId: 'atomic-design-front-end-perspective',
    },
    { name: 'Functional Programming', tagId: 'functional-programming' },
    { name: 'User Stories and TDD', tagId: 'user-stories-and-tdd' },
  ]
---
